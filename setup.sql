...
CREATE TABLE Products(ID INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
...
FOREIGN KEY (category_ID) REFERENCES Categories(ID), FOREIGN KEY (preview) REFERENCES Images(ID));
...
CREATE TABLE OrderAddresses(ID INT UNSIGNED, addr_type CHAR UNIQUE NOT NULL,
...
CREATE TABLE Images(ID INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
product_ID INT UNSIGNED, path TEXT NOT NULL,
FOREIGN KEY (product_ID) REFERENCES Products(ID));

CREATE TABLE Cart(ID INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE Grades(ID INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE TagDefinitions(ID INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
...
title TEXT UNIQUE NOT NULL, img_path TEXT);