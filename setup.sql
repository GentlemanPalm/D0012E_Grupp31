...
payment_option VARCHAR(16), payment_received VARCHAR(16), order_placed TIMESTAMP, discount DECIMAL(10,2),
...
grade INTEGER UNSIGNED NOT NULL, product_ID INT UNSIGNED, user_ID INT UNSIGNED, comment_ID INT UNSIGNED,
FOREIGN KEY (product_ID) REFERENCES Products(ID) ON DELETE CASCADE ON UPDATE CASCADE,
FOREIGN KEY (user_ID) REFERENCES Users(ID) ON DELETE CASCADE ON UPDATE CASCADE,
